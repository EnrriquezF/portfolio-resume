...
export default function Footer() {
  return (
    <footer>
      <div>
        This website is merely a personal website and/or portfolio.
      </div>
      <a href='https://drive.google.com/file/d/1k2XMJ0MmgiQJUih-awxf4JVv-GeaVA2j/view?usp=sharing' target='_blank'
